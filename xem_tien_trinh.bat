...
REM ---------------------------------------------------------------------------
set "THIEU="
if not exist "%~dp0xem_tien_trinh.py" set "THIEU=%THIEU% xem_tien_trinh.py"
...
REM ---------------------------------------------------------------------------
if exist "%~dp0xem_tien_trinh.py" goto :chay
echo.
echo ================================================================
echo   KHONG CHAY DUOC - thieu file xem_tien_trinh.py
echo ================================================================
echo.
echo   Thu muc nay:
echo   "%~dp0"
